...
txl -s 140 SCL5/"$filename"_UID_annotated.scl5 TXL/generateSource.txl -idchars '$' - $CALLBACK > SOURCE/"$filename"_Generated.cpp
# -s 140 fixes problem
...
sed -i 's/PDU \*/PDUP \*/g' SOURCE/SMB2_Generated.cpp
cp SOURCE/SMB2_Generated.cpp ../TCPStream/
