...
bool parseSMB2 (PDU_SMB2 *pdu_smb2, PDU *thePDU, char *progname, uint8_t endianness);
bool parseTEST (TEST_SMB2 *test_smb2, PDU *thePDU, char *progname, uint8_t endianness);
bool parseHEADER (HEADER_SMB2 *header_smb2, PDU *thePDU, char *progname, uint8_t endianness);
bool parseHEADER$ASYNC (HEADER$ASYNC_SMB2 *header$async_smb2, PDU *thePDU, char *progname, uint8_t endianness);
bool parseHEADER$SYNC (HEADER$SYNC_SMB2 *header$sync_smb2, PDU *thePDU, char *progname, uint8_t endianness);
bool parseNEGOTIATE (NEGOTIATE_SMB2 *negotiate_smb2, PDU *thePDU, char *progname, uint8_t endianness);
DIALECT_SMB2 *parseSetOfDIALECT (PDU *thePDU, int n, int *size, char *progname, uint8_t endianness);
bool parseDIALECT (DIALECT_SMB2 *dialect_smb2, PDU *thePDU, char *progname, uint8_t endianness);
